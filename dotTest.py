...
dotPatch =visual.DotStim(myWin, color=(1.0,1.0,1.0), dir=0, units='pix',
        nDots=23, fieldShape='circle', fieldPos=(0,0),fieldSize=100, dotSize=3, 
        dotLife=4, #number of frames for each dot to be drawn
        signalDots='different', #are the signal dots the 'same' on each frame? (see Scase et al)
